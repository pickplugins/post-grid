...
class PGBlockFormFieldFile
{
  ...
  {
    // wp_register_style('editor_style', post_grid_plugin_url . 'includes/blocks/form-field-file/index.css');
    //wp_register_script('editor_script', post_grid_plugin_url . 'includes/blocks/form-field-file/index.js', array('wp-blocks', 'wp-element'));
