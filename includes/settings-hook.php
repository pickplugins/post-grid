            ...
            <?php if ($license_status == 'expired') { ?>
                ...
                <div>
                    <p class="text-lg text-red-600 my-5 font-bold">
                        Your license for Post Grid plugin has expried, please <a target="_blank" class="bg-blue-600 text-white hover:text-white over:bg-blue-700 px-5 py-1" href="https://pickplugins.com/renew-license?renew_license_key=<?php echo $license_key; ?>">Renew</a>
                    </p>
                </div>
