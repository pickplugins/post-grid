...
class PGBlockUserFields
{
  ...
  {
    //wp_register_style('editor_style', post_grid_plugin_url . 'includes/blocks/user-fields/index.css');
    //wp_register_script('editor_script', post_grid_plugin_url . 'includes/blocks/user-fields/index.js', array('wp-blocks', 'wp-element'));
...
?>
    ...
    <<?php echo pg_tag_escape($wrapperTag); ?> class="
      ...
      <?php if (!empty($fieldLink)) : ?>
        ...
        ?>
          <img class="fieldVal" src="<?php echo esc_url_raw(get_avatar_url($userId, ['size' => $fieldAvatarSize])) ?>" alt=" <?php echo esc_attr(get_the_author_meta('display_name', $userId)) ?> " />
        ...
        elseif ($metaKey == 'custom') :
          ...
          ?>
            <img class="fieldVal" width="<?php echo esc_attr($width); ?>" height="<?php echo esc_attr($height); ?>" src="<?php echo esc_url_raw($attachment_url) ?>" alt="<?php echo esc_attr(get_the_author_meta('display_name', $userId)) ?> " />
