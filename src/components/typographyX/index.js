...
class Typography extends Component {
	render() {
		var { typo, breakPointX, onChange, setAttributes, postTitleX } = this.props;
			...
			<div>
						...
						onChange={(newVal) => {
							...
							if (Object.keys(postTitleX.typo.fontSize).length == 0) {
								newValuesObj[breakPointX] = {
									...postTitleX.typo.fontSize[breakPointX],
									val: newVal,
								};
							} else {
					...
					<InputControl
						...
						onChange={(newVal) => {
							...
							if (Object.keys(postTitleX.typo.lineHeight).length == 0) {
								newValuesObj[breakPointX] = {
									...postTitleX.typo.lineHeight[breakPointX],
									val: newVal,
								};
							} else {
					...
					<InputControl
						...
						onChange={(newVal) => {
							...
							if (Object.keys(postTitleX.typo.letterSpacing).length == 0) {
								newValuesObj[breakPointX] = {
									...postTitleX.typo.letterSpacing[breakPointX],
									val: newVal,
								};
							} else {
				...
				<PanelRow>
					...
					<div>
						<Button
							className={
								postTitleX.typo.textDecoration[breakPointX] != undefined &&
								postTitleX.typo.textDecoration[breakPointX].indexOf(
									"underline"
								) !== -1
									? "!bg-blue-300 "
									: ""
