		...
		src: (
			<svg
				...
				<path
					...
					fill="url(#paint1_linear_61_343)"
				/>
				<path
					d="M160 56.9998H84.7061V66.4115H160V56.9998Z"
					fill="url(#paint2_linear_61_343)"
				/>
				<path
					d="M131 94.8818H85V103.882H131V94.8818Z"
					fill="url(#paint3_linear_61_343)"
				/>
			...
			<>
				<InspectorControls>
                  ...
                  />
						...
						<PGTutorials slug="post-category" />
					</div>
				</InspectorControls>

				<>
					{categories.length == 0 && (
						<div {...blockProps}>No Categories Found</div>
					)}
