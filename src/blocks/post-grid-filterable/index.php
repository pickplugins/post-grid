...
class PGBlockPostGridFilterable
{
  ...
  {
    wp_register_script('pgpostgrid_filterable_front_script', post_grid_plugin_url . 'src/blocks/post-grid-filterable/front-scripts.js', []);
    wp_register_style('pgpostgrid_filterable_front_style', post_grid_plugin_url . 'src/blocks/post-grid-filterable/index.css');
