...
add_action('post_grid_pagination_ajax_pagination', 'post_grid_pagination_ajax_pagination', 10, 2);

if (!function_exists('post_grid_pagination_ajax_pagination')) {
    function post_grid_pagination_ajax_pagination($args, $post_grid_wp_query)
    {
...
if (!function_exists('post_grid_paginate_ajax')) {

    function post_grid_paginate_ajax()
    {
...
add_action('wp_ajax_post_grid_paginate_ajax', 'post_grid_paginate_ajax');
add_action('wp_ajax_nopriv_post_grid_paginate_ajax', 'post_grid_paginate_ajax');
