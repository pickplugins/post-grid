...
class class_post_grid_settings
{
    ...
    public function post_grid_menu_init()
    {
        ...
        add_submenu_page('post-grid', __('Overview', 'post-grid'), __('Overview', 'post-grid'), 'manage_options', 'post-grid-overview', array($this, 'overview'), 90);
