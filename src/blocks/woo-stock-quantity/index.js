...
registerBlockType("post-grid/woo-stock-quantity", {
  apiVersion: 2,
  ...
  icon: {
    ...
    src:
      <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36"><path fill="#1d4ed8" d="M16.73,23.81v6.3L9.07,33V26.66Z" /><path fill="#1d4ed8" d="M8.3,26.66V33L.64,30.12v-6.3Z" /><path fill="#1d4ed8" d="M16.68,20.28l-8,3-8-3,5-1.86c.88-.33,1.77-.64,2.65-1a.9.9,0,0,1,.7,0Z" /><path fill="#1d4ed8" d="M17.37,20.82v2L9.08,25.86V23.91Z" /><path fill="#1d4ed8" d="M8.29,25.86,0,22.77V20.82l8.29,3.09Z" /><path fill="#1d4ed8" d="M35.37,23.81v6.3L27.7,33V26.66Z" /><path fill="#1d4ed8" d="M26.93,26.66V33l-7.66-2.86v-6.3Z" /><path fill="#1d4ed8" d="M35.31,20.28l-8,3-8-3,5-1.86c.88-.33,1.77-.64,2.64-1a.9.9,0,0,1,.7,0Z" /><path fill="#1d4ed8" d="M36,20.82v2l-8.29,3.08V23.91Z" /><path fill="#1d4ed8" d="M26.93,25.86l-8.3-3.09V20.82l8.3,3.09Z" /><path fill="#1d4ed8" d="M26.05,9.47v6.3l-7.66,2.86V12.32Z" /><path fill="#1d4ed8" d="M17.61,12.31v6.32L10,15.77V9.47Z" /><path fill="#1d4ed8" d="M26,5.93l-8,3-8-3,5-1.86c.88-.33,1.77-.64,2.65-1a.9.9,0,0,1,.7,0Z" /><path fill="#1d4ed8" d="M26.68,6.47v2L18.4,11.51V9.56Z" /><path fill="#1d4ed8" d="M17.61,11.51,9.32,8.43V6.48l8.29,3.08Z" /></svg>
  ...
  attributes: {
    ...
    icon: {
      type: 'object',
      default: {
        options: { library: 'fontAwesome', srcType: "class", /*class, html, img, svg */ iconSrc: '', position: 'beforeQuantity', /*before, after, prefix, postfix */ class: 'stockQuantity-icon', },
  ...
  edit: function (props) {
    ...
    const [postStokQuantityEdited, setpostStokQuantityEdited] = useState(stockQuantity.options.text);
    ...
    function onPickCssLibraryStokQuantity(args) {
      ...
      Object.entries(args).map(x => {
        var sudoScource = x[0];
        var sudoScourceArgs = x[1];
        var elementSelector = myStore.getElementSelector(sudoScource, stockQuantitySelector);
    ...
    function onRemoveStyleStokQuantity(sudoScource, key) {
      ...
      var object = myStore.deletePropertyDeep(stockQuantity, [sudoScource, key, breakPointX]);
      setAttributes({ stockQuantity: object });
    ...
    var postUrl = (stockQuantity.options.customUrl != undefined && stockQuantity.options.customUrl.length > 0) ? stockQuantity.options.customUrl : currentPostUrl;
    ...
    const blockProps = useBlockProps({
      className: ` ${blockId} pg-woo-stockQuantity`,
          ...
          <div className='' >
              ...
              >
                <PGtab name="options">
                  ...
                  <PanelRow>
                    ...
                    <PGDropdown position="bottom right" variant="secondary" options={linkToArgs} buttonTitle={stockQuantity.options.linkTo.length == 0 ? 'Choose' : linkToArgs[stockQuantity.options.linkTo].label} onChange={setFieldLinkTo} values={[]}></PGDropdown>


                  </PanelRow>

                  {(stockQuantity.options.linkTo == 'authorMeta' || stockQuantity.options.linkTo == 'customField') && (
                    ...
                    <PanelRow>
                      ...
                      <InputControl
                        ...
                        onChange={(newVal) => {
                          ...
                          var options = { ...stockQuantity.options, linkToMetaKey: newVal };
                          setAttributes({ stockQuantity: { ...stockQuantity, options: options } });
                      ...
                      <div className='relative'>
                        ...
                        {stockQuantity.options.customUrl.length > 0 && (
                          <Button className='!text-red-500 ml-2' icon={linkOff} onClick={ev => {
                            ...
                            var options = { ...stockQuantity.options, customUrl: '' };
                            setAttributes({ stockQuantity: { ...stockQuantity, options: options } });
                        ...
                        {linkPickerPosttitle && (
                          <Popover position="bottom right">
                            <LinkControl settings={[]} value={stockQuantity.options.customUrl} onChange={newVal => {

                              var options = { ...stockQuantity.options, customUrl: newVal.url };

                              setAttributes({ stockQuantity: { ...stockQuantity, options: options } });

                            }} />

                            <div className='p-2'><span className='font-bold'>Linked to:</span> {(stockQuantity.options.customUrl.length != 0) ? stockQuantity.options.customUrl : 'No link'} </div>
                          </Popover>
                  ...
                  {stockQuantity.options.linkTo.length == 0 && (
                    ...
                    <PanelRow>
                      ...
                      <SelectControl
                        ...
                        onChange={(newVal) => {
                          var options = { ...stockQuantity.options, tag: newVal };
                          setAttributes({ stockQuantity: { ...stockQuantity, options: options } });
                        }
                      ...
                      <PanelRow>
                        ...
                        <SelectControl
                          ...
                          onChange={(newVal) => {
                            ...
                            var options = { ...stockQuantity.options, linkTarget: newVal };
                            setAttributes({ stockQuantity: { ...stockQuantity, options: options } });
                      ...
                      <PanelRow>
                        ...
                        <div
                          ...
                          onClick={(ev) => {
                            ...
                            var sdsd = stockQuantity.options.linkAttr.concat({ id: '', val: '' })


                            var options = { ...stockQuantity.options, linkAttr: sdsd };
                            setAttributes({ stockQuantity: { ...stockQuantity, options: options } });
                              ...
                              <PanelRow>
                                <InputControl
                                  ...
                                  onChange={(newVal) => {
                                    ...
                                    var options = { ...stockQuantity.options, linkAttr: ssdsd };
                                    setAttributes({ stockQuantity: { ...stockQuantity, options: options } });
                                ...
                                <InputControl
                                  ...
                                  value={x.val}
                                  onChange={(newVal) => {
                                    stockQuantity.options.linkAttr[i].val = newVal
                                    var ssdsd = stockQuantity.options.linkAttr.concat([]);
                ...
                <PGtab name="styles">
                  <PGStyles obj={stockQuantity} onChange={onChangeStyleStokQuantity} onAdd={onAddStyleStokQuantity} onRemove={onRemoveStyleStokQuantity} />
                </PGtab>
                <PGtab name="css">
                  <PGCssLibrary blockId={blockId} obj={stockQuantity} onChange={onPickCssLibraryStokQuantity} />
                </PGtab>
              </PGtabs>
            ...
            <PanelBody title="Custom Style" initialOpen={false}>
              ...
              <div className='my-3'>
                ...
                <p><code>{stockQuantitySelector}{'{/* your CSS here*/}'} </code></p>
              </div>
        ...
        <>
          ...
          {wrapper.options.tag && (
            <CustomTag {...blockProps}>
              ...
              {stockQuantity.options.linkTo.length > 0 && (
                <a className='stockQuantity' onClick={handleLinkClick}  {...linkAttrItems} target={stockQuantity.options.linkTarget} href={postUrl}>

                  {icon.options.position == 'beforeQuantity' && (
                    <span className={icon.options.class} dangerouslySetInnerHTML={{ __html: iconHtml }} />
                  )}
                  <span className='stockQuantity-text'>{postStokQuantityEdited}</span>
          ...
          {wrapper.options.tag.length == 0 && (
            ...
            <>
              ...
              {stockQuantity.options.linkTo.length > 0 && (
                <a {...blockProps} onClick={handleLinkClick}  {...linkAttrItems} target={stockQuantity.options.linkTarget} href={postUrl}>
