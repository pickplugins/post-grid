...
class PGBlockGalleryImagesField
{
  ...
  {
    //wp_register_style('editor_style', post_grid_plugin_url . 'includes/blocks/gallery-images-field/index.css');
    //wp_register_script('editor_script', post_grid_plugin_url . 'includes/blocks/gallery-images-field/index.js', array('wp-blocks', 'wp-element'));


    register_block_type(
      post_grid_plugin_dir . 'build/blocks/gallery-images-field/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    //echo "<pre>" . var_export($block->context, true) . "</pre>";
    ...
    if (!empty($block->context)) {
      //echo "<pre>" . var_export($galleryId, true) . "</pre>";
    }
    ...
    //echo "<pre>" . var_export($imageData, true) . "</pre>";
