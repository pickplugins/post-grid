...
class Typography extends Component {
	render() {
		var { typo, breakPointX, onChange, setAttributes, obj } = this.props;
				...
				{typo.fontFamily != undefined && (
					<>
						<PanelRow>
							...
							<InputControl
								value={
									typo.fontFamily[breakPointX] != undefined
										? typo.fontFamily[breakPointX]
										: ""
								}
								onChange={(newVal) => {
									var newValuesObj = {};
						...
						<PanelRow>
							...
							<div className="flex">
								<InputControl
									type="number"
									value={
										typo.fontSize[breakPointX] != undefined
											? typo.fontSize[breakPointX].val
											: ""
									}
									onChange={(newVal) => {
										var newValuesObj = {};
										if (Object.keys(obj.styles.fontSize).length == 0) {
											newValuesObj[breakPointX] = {
												...obj.styles.fontSize[breakPointX],
												val: newVal,
											};
										} else {
								...
								<SelectControl
									...
									value={
										typo.fontSize[breakPointX] != undefined
											? typo.fontSize[breakPointX].unit
											: ""
									}
									options={[
						...
						<PanelRow>
							...
							<div className="flex">
								<InputControl
									type="number"
									value={
										typo.lineHeight[breakPointX] != undefined
											? typo.lineHeight[breakPointX].val
											: ""
									}
									onChange={(newVal) => {
										var newValuesObj = {};
										if (Object.keys(obj.styles.lineHeight).length == 0) {
											newValuesObj[breakPointX] = {
												...obj.styles.lineHeight[breakPointX],
												val: newVal,
											};
										} else {
								...
								<SelectControl
									...
									value={
										typo.lineHeight[breakPointX] != undefined
											? typo.lineHeight[breakPointX].unit
											: ""
									}
									options={[
										{ label: "Select Unit", value: "" },
						...
						<PanelRow>
							...
							<div className="flex">
								<InputControl
									type="number"
									value={
										typo.letterSpacing[breakPointX] != undefined
											? typo.letterSpacing[breakPointX].val
											: ""
									}
									onChange={(newVal) => {
										var newValuesObj = {};
										if (Object.keys(obj.styles.letterSpacing).length == 0) {
											newValuesObj[breakPointX] = {
												...obj.styles.letterSpacing[breakPointX],
												val: newVal,
											};
										} else {
								...
								<SelectControl
									...
									value={
										typo.letterSpacing[breakPointX] != undefined
											? typo.letterSpacing[breakPointX].unit
											: ""
									}
									options={[
										{ label: "Select Unit", value: "" },
					...
					<>
						<PanelRow>
							...
							<SelectControl
								label=""
								value={
									typo.fontWeight[breakPointX] != undefined
										? typo.fontWeight[breakPointX]
										: ""
								}
								options={[
									{ label: "Select...", value: "" },
					...
					<>
						<PanelRow>
							...
							<SelectControl
								label=""
								value={
									typo.textTransform[breakPointX] != undefined
										? typo.textTransform[breakPointX]
										: ""
								}
								options={[
									{ label: "Select...", value: "" },
					...
					<>
						<PanelRow>
							...
							<div className="flex justify-between">
								<Button
									className={
										obj.styles.textDecoration[breakPointX] != undefined &&
										obj.styles.textDecoration[breakPointX].indexOf(
											"underline"
										) !== -1
											? "!bg-blue-300 "
											: ""
									...
									onClick={(ev) => {
										...
										if (Object.keys(obj.styles.textDecoration).length == 0) {
											...
											if (newValuesObj[breakPointX].indexOf(newVal) !== -1) {
												var arr = newValuesObj[breakPointX].filter(
													(item) => item !== newVal
												);
								...
								<Button
									...
									<span className="icon-overline"></span>
								</Button>

								<Button
									className={
										obj.styles.textDecoration[breakPointX] != undefined &&
										obj.styles.textDecoration[breakPointX].indexOf("none") !==
											-1
											? "!bg-blue-300 "
											: ""
									}
