...
registerBlockType(metadata, {
	icon: {
		...
		src: (
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
				<rect fill="#8db1ff" x="0.62" y="3.01" width="16.33" height="29.98" />
				<polygon
					fill="#1d4ed8"
					points="10.11 13.85 6.75 18.67 5.42 16.76 1.66 22.16 15.9 22.16 10.11 13.85"
				/>
				<rect
					fill="#8db1ff"
					x="20.25"
					...
					width="13.93"
					height="16.33"
					transform="translate(37.19 -17.24) rotate(90)"
				/>
				<polygon
					fill="#1d4ed8"
					points="28.38 6.37 25.45 10.56 24.3 8.9 21.03 13.58 33.41 13.58 28.38 6.37"
				/>
				<rect
					fill="#8db1ff"
					x="20.25"
					...
					width="13.93"
					height="16.33"
					transform="translate(53.24 -1.19) rotate(90)"
				/>
				<polygon
					fill="#1d4ed8"
					points="28.38 22.42 25.45 26.61 24.3 24.95 21.03 29.64 33.41 29.64 28.38 22.42"
				/>
			</svg>
		),
	},
	...
	edit: function (props) {
		...
		const addChild = () => {
			...
			const slide = createBlock("post-grid/image-gallery-item");
