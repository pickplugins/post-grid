...
class PGBlockTabs
{
    ...
    {
        wp_register_script('pgtabs_front_script', post_grid_plugin_url . 'src/blocks/tabs-nested/front-scripts.js', [], '', true);
        wp_register_style('pgtabs_front_style', post_grid_plugin_url . 'src/blocks/tabs-nested/index.css');
    ...
    function register_scripts()
    {
        ...
        register_block_type('post-grid/tabs-nested', array(
...
?>
        <div id="<?php echo esc_attr($blockId); ?>" class="pg-tabs <?php echo esc_attr($blockId); ?>">
            <div class="navs-wrapper">
                ...
                ?>
                    <div id="<?php echo  esc_attr($tab['uid']); ?>" data-tab-id="<?php echo  esc_attr($tab['uid']); ?>" class="<?php echo ($tab['uid'] == $activeTab) ? 'nav-item nav-item-active  ' : 'nav-item ' ?>" role="tab" tabIndex="0">
