...
registerBlockType(metadata, {
		...
		src: (
			<svg
				...
				<path
					...
					fill="url(#paint0_linear_67_1060)"
				/>
				<path
				...
				/>
				<path
					d="M108.076 52.4067V72.7149H103.762V56.4765H103.64L99 59.4067V55.5812L104.047 52.4067H108.076Z"
					fill="#C15940"
				/>
				<path
				...
				/>
				<path
					d="M47.9837 78.4038C47.9837 83.8613 47.9837 89.1256 47.9837 94.5831C41.512 96.9979 34.9437 99.461 28.3271 101.924C28.3271 96.4666 28.3271 91.154 28.3271 85.6965C34.7988 83.33 41.3188 80.8669 47.9837 78.4038Z"
					fill="url(#paint2_linear_67_1060)"
				/>
				<path
					d="M26.2991 85.6965C26.2991 91.1057 26.2991 96.4183 26.2991 101.924C19.6825 99.461 13.1626 96.9979 6.64258 94.5831C6.64258 89.2222 6.64258 83.9096 6.64258 78.4038C13.3075 80.8669 19.8274 83.2817 26.2991 85.6965Z"
					fill="url(#paint3_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint4_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint5_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint6_linear_67_1060)"
				/>
				<path
					d="M95.7967 78.4038C95.7967 83.8613 95.7967 89.1256 95.7967 94.5831C89.325 96.9979 82.7567 99.461 76.1401 101.924C76.1401 96.4666 76.1401 91.154 76.1401 85.6965C82.6118 83.33 89.1801 80.8669 95.7967 78.4038Z"
					fill="url(#paint7_linear_67_1060)"
				/>
				<path
					d="M74.1605 85.6965C74.1605 91.1057 74.1605 96.4183 74.1605 101.924C67.5439 99.461 61.0239 96.9979 54.5039 94.5831C54.5039 89.2222 54.5039 83.9096 54.5039 78.4038C61.1205 80.8669 67.6405 83.2817 74.1605 85.6965Z"
					fill="url(#paint8_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint9_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint10_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint11_linear_67_1060)"
				/>
				<path
					d="M71.8904 41.5537C71.8904 47.0112 71.8904 52.2755 71.8904 57.733C65.4187 60.1478 58.8505 62.6109 52.2339 65.074C52.2339 59.6165 52.2339 54.3039 52.2339 48.8464C58.7056 46.4799 65.2256 44.0651 71.8904 41.5537Z"
					fill="url(#paint12_linear_67_1060)"
				/>
				<path
					d="M50.2533 48.8948C50.2533 54.304 50.2533 59.6165 50.2533 65.1223C43.6367 62.6592 37.1167 60.1961 30.5967 57.7813C30.5967 52.4204 30.5967 47.1078 30.5967 41.6021C37.2133 44.0652 43.7333 46.48 50.2533 48.8948Z"
					fill="url(#paint13_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint14_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint15_linear_67_1060)"
				/>
				<path
					...
					fill="url(#paint16_linear_67_1060)"
				/>
				<defs>
					<linearGradient
						id="paint0_linear_67_1060"
						x1="0"
						y1="121.056"
						x2="160"
						y2="121.056"
	...
	edit: function (props) {
		...
		function onBulkAddStockQuantity(sudoScource, cssObj) {
			let obj = Object.assign({}, stockQuantity);
			obj[sudoScource] = cssObj;

			setAttributes({ stockQuantity: obj });
		...
		function onResetStockQuantity(sudoScources) {
			let obj = Object.assign({}, stockQuantity);
			...
			<>
				<InspectorControls>
					<div className="pg-setting-input-text">
							...
							<PGtabs
								...
								<PGtab name="styles">
									<PGStyles
										...
										onBulkAdd={onBulkAddStockQuantity}
										onReset={onResetStockQuantity}
									/>
								</PGtab>
								<PGtab name="css">
									<PGCssLibrary
						...
						/>
						<div className="px-3">
							<PGTutorials slug="woo-stock-quantity" />
						</div>
					</div>
				</InspectorControls>
