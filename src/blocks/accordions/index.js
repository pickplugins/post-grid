	...
	icon: {
		...
		src: (
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
				<rect fill="#fff" y="6.2" width="36" height="4.21" />
				<path
					fill="#C5C5C5"
				...
				/>
				<rect fill="#C5C5C5" x="6.07" y="7.76" width="17.44" height="1.11" />
				<rect fill="#C5C5C5" y="16.16" width="36" height="8.66" />
				<rect fill="#C5C5C5" y="11.18" width="36" height="4.21" />
				<path
					fill="#fff"
				...
				/>
				<rect fill="#fff" x="6.07" y="12.73" width="17.44" height="1.11" />
				<rect fill="#fff" y="25.58" width="36" height="4.21" />
				<path
					fill="#C5C5C5"
				...
				/>
				<rect fill="#C5C5C5" x="6.07" y="27.13" width="17.44" height="1.11" />
			</svg>
		),
	},
		...
		labelIcon: {
			...
			default: {
				options: {
					...
					position: "left",
					/*left, right, before, after */ class: "accordion-icon",
				},
		...
		iconToggle: {
			...
			default: {
				options: {
					library: "fontAwesome",
					srcType: "class",
					/*class, html, img, svg */ iconSrc: "fas fa-angle-up",
					...
					<div className="px-3">
						<PanelBody title="Pre-Sets" initialOpen={true}>
							...
							<div className="grid grid-cols-2 gap-2 my-4">
								<div
									className="bg-[#5655ff] p-2 cursor-pointer"
									onClick={(ev) => {
										var headerstyles = {
											...header.styles,
									...
									<ToggleControl
										...
										onChange={(e) => {
											...
											childBlocks.map((childBlock) => {
												var childClientId = childBlock.clientId;
												var childAttributes = childBlock.attributes;
												childAttributes.labelCounter.options.enable =
													labelCounter.options.enable ? true : false;
										...
										<PGIconPicker
											...
											onChange={(arg) => {
												...
												childBlocks.map((childBlock) => {
													var childClientId = childBlock.clientId;
													var childAttributes = childBlock.attributes;
													childAttributes.iconToggle.options.srcType =
														arg.srcType;
													childAttributes.iconToggle.options.library =
														arg.library;
													childAttributes.iconToggle.options.iconSrc =
														arg.iconSrc;
