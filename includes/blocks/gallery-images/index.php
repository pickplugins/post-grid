...
class PGBlockGalleryImages
{
  ...
  function register_scripts()
  {
    ...
    register_block_type(
      post_grid_plugin_dir . 'build/blocks/gallery-images/block.json',
      array(
  ...
  {
    // wp_register_script('pgpostquery_front_script', post_grid_plugin_url . 'includes/blocks/gallery-images/front-scripts.js', []);
    // wp_register_style('pgpostquery_front_style', post_grid_plugin_url . 'includes/blocks/gallery-images/index.css');
    if (has_block('post-grid/gallery-images')) {
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    //echo "<pre>" . var_export($block->clientId, true) . "</pre>";
...
?>
    ...
    ?>
      ...
      <div class="<?php echo esc_attr($blockId); ?> pg-gallery-images items-loop" id="items-loop-<?php echo esc_attr($blockId); ?>" blockArgs="<?php echo esc_attr(json_encode($blockArgs)); ?>">
      <?php
    endif;
      ?>
      <?php
      ...
      if (!empty($galleryItems))
        foreach ($galleryItems as $index => $galleryItem) {
          ...
          //echo "<pre>" . var_export($imageId, true) . "</pre>";
