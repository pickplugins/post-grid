				...
				<PGtab name="cssItems">
					...
					<div className="items">
						{cssLibrary.items.map((x, index) => {
							...
							return (
								<div
									className={`item-${index} border border-solid relative border-slate-400 rounded-md shadow-md py-2 my-3 transition-all duration-300 ease-in-out `}
									// onMouseEnter={() => {
									// 	setIsHovered(true);
									// 	setHoverValue(index);
									// }}
								...
								>
									...
									<div
										className="my-2 mb-0 w-full bg-slate-400 bg-opacity-30 flex items-center justify-center flex-wrap gap-2 opacity-100 visible h-[max-content] 
										...
										{(!x.is_pro || (x.is_pro && !isProFeature)) && (
											<div className="flex items-center justify-evenly w-full flex-wrap gap-2 px-3 py-2">
												<a
