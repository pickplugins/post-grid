    ...
    <div class="p-5 bg-white">
        <div class="grid grid-cols-12 gap-3">
            ...
            <div class="col-span-6 text-right">
                ...
                <a href="https://pickplugins.com/documentation/post-grid-combo/" target="_blank" class="inline-block px-4 py-2 rounded-sm bg-blue-600 text-white text-lg mx-2 hover:text-white ">Documentation</a>
