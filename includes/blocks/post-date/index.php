...
class PGBlocPostDate
{
    ...
    {
        //wp_register_style('editor_style', post_grid_plugin_url . 'includes/blocks/post-date/index.css');
        //wp_register_script('editor_script', post_grid_plugin_url . 'includes/blocks/post-date/index.js', array('wp-blocks', 'wp-element'));
...
?>
            <<?php echo esc_attr($wrapperTag); ?> class="
                ...
                ?>
                    <a class='postdate-text' <?php echo ($linkAttrStrpostDate); ?> target="<?php echo esc_attr($postDateLinkTarget); ?>" rel="<?php echo esc_attr($postDateRel); ?>" href="<?php echo (!empty($linkUrl)) ? esc_url_raw($linkUrl) : esc_url_raw($post_url); ?>">
