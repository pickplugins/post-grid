...
import { createElement, createRoot, Platform, useCallback, memo, useMemo, useState, useEffect } from '@wordpress/element'
...
function wpblockhubImportButton() {
    ...
    setTimeout(() => {
        ...
        html2 += '<div   id="pgTemplates-items" class="pgTemplates-items hidden fixed z-[999] top-6 opacity-80 left-0 w-full h-full bg-gray-400">Hello</div>';
