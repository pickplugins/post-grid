	...
	icon: {
		...
		src: (
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36">
				<rect fill="#1d4ed8" y="16.57" width="13.97" height="2" />
				<rect fill="#1d4ed8" y="12.32" width="36" height="2" />
				<rect fill="#1d4ed8" y="6.41" width="36" height="2.35" />
				<path
					fill="#8db1ff"
