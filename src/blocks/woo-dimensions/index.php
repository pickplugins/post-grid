...
class PGBlockWooDimensions
{
    ...
    {
        //wp_register_style('editor_style', post_grid_plugin_url . 'src/blocks/woo-dimensions/index.css');
        // wp_register_script('editor_script', post_grid_plugin_url . 'src/blocks/woo-dimensions/index.js', array('wp-blocks', 'wp-element'));


        register_block_type('post-grid/woo-dimensions', array(
...
$PGBlockWooDimensions = new PGBlockWooDimensions();
