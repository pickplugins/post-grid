...
class PGBlockWooStockQuantity
{
    ...
    {
        //wp_register_style('editor_style', post_grid_plugin_url . 'includes/blocks/woo-stock-quantity/index.css');
        //wp_register_script('editor_script', post_grid_plugin_url . 'includes/blocks/woo-stock-quantity/index.js', array('wp-blocks', 'wp-element'));
            ...
            ?>
                                    <<?php echo esc_attr($wrapperTag); ?> class="
                                        ...
                                        <?php if (!empty($skuLinkTo)):
                                            ...
                                            ?>
                                                    <a class='stockQuantity-text' <?php echo ($linkAttrStrsku); ?> target="<?php echo esc_attr($skuLinkTarget); ?>"
