...
class PGBlockFlexWrap
{
    ...
    {
        wp_register_script('pgflex-wrap_front_script', post_grid_plugin_url . 'src/blocks/flex-wrap/front-scripts.js', [], '', true);
    ...
    function register_scripts()
    {
        ...
        register_block_type(post_grid_plugin_dir . 'src/blocks/flex-wrap/block.json', array(
