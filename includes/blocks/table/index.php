...
class PGBlockTable
{
  ...
  {
    //wp_register_style('editor_style', post_grid_plugin_url . 'includes/blocks/table/index.css');
    //wp_register_script('editor_script', post_grid_plugin_url . 'includes/blocks/table/index.js', array('wp-blocks', 'wp-element'));
...
<<?php echo tag_escape($wrapperTag); ?> class="<?php echo esc_attr($blockId); ?> <?php echo esc_attr($wrapperClass); ?>"
  ...
  <table id="<?php echo esc_attr($wrapperID); ?>"
