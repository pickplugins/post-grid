...
registerBlockType(metadata, {
	icon: {
		...
		src: (
			<svg
				...
				<path
					d="M28.9103 58H2.22206C1.63222 58 1.06653 58.2343 0.649447 58.6514C0.232363 59.0685 -0.00195313 59.6342 -0.00195312 60.224V82.4642C-0.00195313 83.054 0.232363 83.6197 0.649447 84.0368C1.06653 84.4539 1.63222 84.6882 2.22206 84.6882H28.9103C29.5001 84.6882 30.0658 84.4539 30.4829 84.0368C30.9 83.6197 31.1343 83.054 31.1343 82.4642V60.224C31.1343 59.6342 30.9 59.0685 30.4829 58.6514C30.0658 58.2343 29.5001 58 28.9103 58ZM26.6862 80.2402H4.44608V62.448H26.6862V80.2402Z"
					fill="url(#paint0_linear_61_94)"
				/>
				<path
					d="M75.615 64.6719H40.0308V69.1199H75.615V64.6719Z"
					fill="url(#paint1_linear_61_94)"
				/>
				<path
					d="M66.719 73.5679H40.0308V78.0159H66.719V73.5679Z"
					fill="url(#paint2_linear_61_94)"
				/>
				<path
					d="M113.294 58H86.6054C86.0155 58 85.4498 58.2343 85.0327 58.6514C84.6157 59.0685 84.3813 59.6342 84.3813 60.224V82.4642C84.3813 83.054 84.6157 83.6197 85.0327 84.0368C85.4498 84.4539 86.0155 84.6882 86.6054 84.6882H113.294C113.883 84.6882 114.449 84.4539 114.866 84.0368C115.283 83.6197 115.518 83.054 115.518 82.4642V60.224C115.518 59.6342 115.283 59.0685 114.866 58.6514C114.449 58.2343 113.883 58 113.294 58ZM111.07 80.2402H88.8294V62.448H111.07V80.2402Z"
					fill="url(#paint3_linear_61_94)"
				/>
				<path
					d="M159.998 64.6719H124.414V69.1199H159.998V64.6719Z"
					fill="url(#paint4_linear_61_94)"
				/>
				<path
					d="M151.102 73.5679H124.414V78.0159H151.102V73.5679Z"
					fill="url(#paint5_linear_61_94)"
				/>
				<circle cx="79.998" cy="98.6885" r="4" fill="#C15940" />
				<circle
					cx="97.998"
					cy="98.6885"
					r="4"
					fill="url(#paint6_linear_61_94)"
				/>
				<circle
					cx="61.998"
					cy="98.6885"
					r="4"
					fill="url(#paint7_linear_61_94)"
				/>
				<defs>
					<linearGradient
						id="paint0_linear_61_94"
						x1="-0.00195313"
						y1="71.3441"
						x2="31.1343"
						y2="71.3441"
	...
	edit: function (props) {
		...
		function onRemoveStylePrev(sudoScource, key) {
			var object = myStore.deletePropertyDeep(perv, [
				sudoScource,
				key,
				breakPointX,
			]);
		...
		function onRemoveStylePaginationActive(sudoScource, key) {
			var object = myStore.deletePropertyDeep(paginationActive, [
				sudoScource,
				key,
				breakPointX,
			]);
		...
		function onRemoveStylePaginationWrap(sudoScource, key) {
			var object = myStore.deletePropertyDeep(paginationWrap, [
				sudoScource,
				key,
				breakPointX,
			]);
		...
		function onRemoveStyleNextIcon(sudoScource, key) {
			var object = myStore.deletePropertyDeep(nextIcon, [
				sudoScource,
				key,
				breakPointX,
			]);
		...
		function onRemoveStylePervIcon(sudoScource, key) {
			var object = myStore.deletePropertyDeep(pervIcon, [
				sudoScource,
				key,
				breakPointX,
			]);
			...
			<>
				<InspectorControls>
					<div className="pg-setting-input-text">
						...
						<div className="px-3">
							<PGTutorials slug="content-slider" />
						</div>
					</div>
				</InspectorControls>
								...
								<div className="splide__arrows">
									<div className="perv splide__arrow splide__arrow--prev">
										{pervIcon.options.position == "before" && (
											<span
												className="icon"
												dangerouslySetInnerHTML={{ __html: pervIconHtml }}
											/>
										)}
	...
	save: function (props) {
		...
		var pervIconHtml = `<span className="${pervIcon.options.iconSrc}"></span>`;
		var nextIconHtml = `<span className="${nextIcon.options.iconSrc}"></span>`;
