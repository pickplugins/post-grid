...
add_action('post_grid_settings_tabs_content_general', 'post_grid_settings_tabs_content_general', 10, 2);

function post_grid_settings_tabs_content_general($tab, $post_id){
