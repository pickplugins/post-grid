...
registerBlockType("post-grid/woo-total-sales", {
  ...
  attributes: {
    ...
    icon: {
      type: 'object',
      default: {
        options: { library: 'fontAwesome', srcType: "class", /*class, html, img, svg */ iconSrc: '', position: 'beforeSaleCount', /*before, after, prefix, postfix */ class: 'saleCount-icon', },
  ...
  edit: function (props) {
    ...
    const [postSaleCountEdited, setpostSaleCountEdited] = useState(saleCount.options.text);
    ...
    function onPickCssLibrarySaleCount(args) {
      ...
      Object.entries(args).map(x => {
        var sudoScource = x[0];
        var sudoScourceArgs = x[1];
        var elementSelector = myStore.getElementSelector(sudoScource, saleCountSelector);
    ...
    function onRemoveStyleSaleCount(sudoScource, key) {
      ...
      var object = myStore.deletePropertyDeep(saleCount, [sudoScource, key, breakPointX]);
      setAttributes({ saleCount: object });
    ...
    var postUrl = (saleCount.options.customUrl != undefined && saleCount.options.customUrl.length > 0) ? saleCount.options.customUrl : currentPostUrl;
          ...
          <div className='' >
              ...
              >
                <PGtab name="options">
                  ...
                  <PanelRow>
                    ...
                    <PGDropdown position="bottom right" variant="secondary" options={linkToArgs} buttonTitle={saleCount.options.linkTo.length == 0 ? 'Choose' : linkToArgs[saleCount.options.linkTo].label} onChange={setFieldLinkTo} values={[]}></PGDropdown>


                  </PanelRow>

                  {(saleCount.options.linkTo == 'authorMeta' || saleCount.options.linkTo == 'customField') && (
                    ...
                    <PanelRow>
                      ...
                      <InputControl
                        ...
                        onChange={(newVal) => {
                          ...
                          var options = { ...saleCount.options, linkToMetaKey: newVal };
                          setAttributes({ saleCount: { ...saleCount, options: options } });
                      ...
                      <div className='relative'>
                        ...
                        {saleCount.options.customUrl.length > 0 && (
                          <Button className='!text-red-500 ml-2' icon={linkOff} onClick={ev => {
                            ...
                            var options = { ...saleCount.options, customUrl: '' };
                            setAttributes({ saleCount: { ...saleCount, options: options } });
                        ...
                        {linkPickerPosttitle && (
                          <Popover position="bottom right">
                            <LinkControl settings={[]} value={saleCount.options.customUrl} onChange={newVal => {

                              var options = { ...saleCount.options, customUrl: newVal.url };

                              setAttributes({ saleCount: { ...saleCount, options: options } });

                            }} />

                            <div className='p-2'><span className='font-bold'>Linked to:</span> {(saleCount.options.customUrl.length != 0) ? saleCount.options.customUrl : 'No link'} </div>
                          </Popover>
                      ...
                      <PanelRow>
                        ...
                        <SelectControl
                          ...
                          onChange={(newVal) => {
                            ...
                            var options = { ...saleCount.options, linkTarget: newVal };
                            setAttributes({ saleCount: { ...saleCount, options: options } });
                      ...
                      <PanelRow>
                        ...
                        <div
                          ...
                          onClick={(ev) => {
                            ...
                            var sdsd = saleCount.options.linkAttr.concat({ id: '', val: '' })


                            var options = { ...saleCount.options, linkAttr: sdsd };
                            setAttributes({ saleCount: { ...saleCount, options: options } });
                              ...
                              <PanelRow>
                                <InputControl
                                  ...
                                  onChange={(newVal) => {
                                    ...
                                    var options = { ...saleCount.options, linkAttr: ssdsd };
                                    setAttributes({ saleCount: { ...saleCount, options: options } });
                ...
                <PGtab name="styles">
                  <PGStyles obj={saleCount} onChange={onChangeStyleSaleCount} onAdd={onAddStyleSaleCount} onRemove={onRemoveStyleSaleCount} />
                </PGtab>
                <PGtab name="css">
                  <PGCssLibrary blockId={blockId} obj={saleCount} onChange={onPickCssLibrarySaleCount} />
                </PGtab>
              </PGtabs>
            ...
            <PanelBody title="Custom Style" initialOpen={false}>
              ...
              <div className='my-3'>
                ...
                <p><code>{saleCountSelector}{'{/* your CSS here*/}'} </code></p>
              </div>
        ...
        <>
          ...
          {wrapper.options.tag && (
            <CustomTag {...blockProps}>
              ...
              {saleCount.options.linkTo.length > 0 && (
                <a className='saleCount' onClick={handleLinkClick}  {...linkAttrItems} target={saleCount.options.linkTarget} href={postUrl}>
          ...
          {wrapper.options.tag.length == 0 && (
            ...
            <>
              ...
              {saleCount.options.linkTo.length > 0 && (
                <a {...blockProps} onClick={handleLinkClick}  {...linkAttrItems} target={saleCount.options.linkTarget} href={postUrl}>
