...
class PGBlockJustifiedImage
{
  ...
  function register_scripts()
  {
    ...
    register_block_type(
      post_grid_plugin_dir . 'build/blocks/justified-image/block.json',
      array(
  ...
  function theHTML($attributes, $content, $block)
  {
    ...
    if (has_block('post-grid/justified-image')) {
...
$PGBlockJustifiedImage = new PGBlockJustifiedImage();