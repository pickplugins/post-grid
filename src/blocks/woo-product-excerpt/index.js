...
registerBlockType("post-grid/woo-product-excerpt", {
  apiVersion: 2,
  ...
  edit: function (props) {
    ...
    const blockProps = useBlockProps({
      className: ` ${blockId} pg-product-excerpt`,
        ...
        <InspectorControls >
          ...
          <PanelBody title="Read More" initialOpen={false}>
            ...
            >
              ...
              <PGtab name="css">
                <PGCssLibrary blockId={blockId} obj={readMore} onChange={onPickCssLibraryRedmore} />
              </PGtab>
            </PGtabs>
