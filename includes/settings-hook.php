...
if (!function_exists('post_grid_settings_content_buy_pro')) {
    ...
    ?>
        <div class="section">
            <div class="section-title"><?php echo __('Pre Order', 'post-grid'); ?></div>
            ...
            <a class="button" href="https://www.pickplugins.com/post-grid/"><?php echo __('Buy premium', 'post-grid'); ?></a>
            ...
            <table class="pro-features">
                ...
                <tr>
                    ...
                    <td> </td>
                    <td><a class="button" href="https://www.pickplugins.com/post-grid/"><?php echo __('Buy premium', 'post-grid'); ?></a></td>
                </tr>
