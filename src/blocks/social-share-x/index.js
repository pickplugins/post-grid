...
registerBlockType("post-grid/social-share-x", {
  title: "Social Share",
  icon: {
  ...
  attributes: {
    ...
    elements: {
      ...
      "default": {
        options: {
          linkTarget: '_blank', showLabel: true, showCount: true, iconPositon: 'beforeLabel' // beforeLabel, afterLabel, beforeCount, afterCount
        },
        styles: {
          textAlign: {},
          color: {},
        ...
        items: [
          {
            id: 'facebook', label: 'Facebook', url: 'https://www.facebook.com/sharer.php?u={URL}', siteIcon: { library: 'fontAwesome', srcType: "class", /*class, html, img, svg */ iconSrc: 'fas fa-chevron-right', },
            styles: {
              textAlign: {},
              color: {},
              bgColor: {},
          ...
          {
            id: 'twitter', label: 'Twitter', url: 'https://twitter.com/intent/tweet?url={URL}', siteIcon: { library: 'fontAwesome', srcType: "class", /*class, html, img, svg */ iconSrc: 'fas fa-chevron-right', },
            styles: {
              textAlign: {},
              color: {},
              bgColor: {},
          ...
          {
            id: 'linkedin', label: 'Linkedin', url: 'https://www.linkedin.com/shareArticle?mini=true&url={URL}&title={TITLE}', siteIcon: { library: 'fontAwesome', srcType: "class", /*class, html, img, svg */ iconSrc: 'fas fa-chevron-right', },
            styles: {
              textAlign: {},
              color: {},
              bgColor: {},
  ...
  edit: function (props) {
    ...
    var itemIconSelector = blockClass + ' .media-item .icon';
    var itemLabelSelector = blockClass + ' .media-item .media-label';
        ...
        Object.entries(styles).map(y => {
          ...
          if (Object.keys(attrVal).length != 0) {
            ...
            if (blockCssY.items[itemSelector + '.item-' + index] == undefined) {
              ...
              newValuesObjX[itemSelector + '.item-' + index] = blockCssY.items[itemSelector + '.item-' + index];
            ...
            console.log(newValuesObjX);

            setAttributes({ blockCssY: { ...blockCssY.items, items: newValuesObjX } });
    ...
    var mediaSites = [
      ...
      {
        id: 'pinterest', label: 'Pinterest', url: 'https://www.pinterest.com/pin/create/button/?url={URL}&media={IMAGE}', siteIcon: { library: 'fontAwesome', srcType: "class", /*class, html, img, svg */ iconSrc: 'fas fa-chevron-right', },
        styles: {
          textAlign: {},
          color: {},
          bgColor: {},
                          ...
                          <ColorPalette
                            ...
                            onChange={(newVal) => {
                              ...
                              if (blockCssY.items[itemSelector + ' .item-' + index] == undefined) {
                                ...
                                newValuesObjX[itemSelector + ' .item-' + index] = { ...blockCssY.items[itemSelector + ' .item-' + index], color: newValuesObj };
